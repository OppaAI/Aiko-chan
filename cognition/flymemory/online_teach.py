...
def teach_from_user_text(
    ...
    *,
    ...
    try:
        from cognition.flymemory.teach_api import extract_topic, teach_preference
        topic = extract_topic(t)
        if topic and (_STOP_TOPIC_RE.search(t) or re.search(r"\b(avoid|never (?:talk|bring))\b", t, re.I)):
