...
core.think and core.agentic.

Two fetch groups use this pool:
  1. Memory + KB (core.think._fetch_memory_and_knowledge) — fired from
  ...
  2. Wiki + agentic-policy + skill + experience
     (core.agentic._fetch_agentic_only_context) — fired only once intent
